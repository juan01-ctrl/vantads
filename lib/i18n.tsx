...
const NESTED = {
  en: {
    ...
    plans: {
      essential: { name: "Essential", volume: "10 videos / month", description: "For brands that need a consistent monthly presence.", price: "$390 / month", perVideo: "$39 / video", discount: "Standard rate", cta: "Start Essential", features: ["10 vertical product ads", "Up to 20 seconds each", "1 revision round per video", "Instagram-ready 9:16 delivery", "Basic motion typography", "Standard delivery schedule"] },
    ...
    info: {
      ...
      process: [
        ...
        ["Per video", "Revisions", "Each video includes 1–2 revision rounds depending on your plan. You send feedback, we refine."],
      ...
      plans: [
        { name: "Essential", volume: "10 videos / month", price: "$390 / month", perVideo: "$39 / video", features: "10 vertical product ads · up to 20 seconds · 1 revision round · 9:16 delivery · basic motion typography" },
  ...
  es: {
    ...
    plans: {
      ...
      growth: { name: "Growth", volume: "20 videos / mes", description: "Para ecommerce que testea y escala creativos activamente.", price: "$585 / mes", perVideo: "$29.25 / video", discount: "Ahorrá 25%", cta: "Elegir Growth", features: ["20 anuncios de producto verticales", "Hasta 20 segundos cada uno", "Múltiples hooks y variaciones", "2 rondas de revisiones por video", "Motion design premium", "Dirección creativa incluida", "Producción prioritaria", "Exports listos para campaña"] },
    ...
    info: {
      ...
      process: [
        ...
        ["Por video", "Revisiones", "Cada video incluye 1–2 rondas de revisiones según tu plan. Enviás feedback y lo refinamos."],
      ...
      plans: [
        { name: "Essential", volume: "10 videos / mes", price: "ARS $585.000 / mes", perVideo: "ARS $58.500 / video", features: "10 anuncios de producto verticales · hasta 20 segundos · 1 ronda de revisiones · entrega 9:16 · tipografía de movimiento básica" },
