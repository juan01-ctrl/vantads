...
const NESTED = {
  en: {
    ...
    info: {
      ...
      plans: [
        { name: "Essential", volume: "8 videos / month", price: "$460 / month", features: "8 videos · 12 product photos · creative direction · multiple concepts & hooks · 2 revision rounds" },
        { name: "Growth", volume: "12 videos / month", price: "$620 / month", features: "12 videos · 20 product photos · creative direction · multiple concepts & hooks · premium motion & editing · 2 revision rounds" },
        { name: "Scale", volume: "16+ videos / month", price: "From $790 / month", features: "16+ videos · 36 product photos · higher creative volume · multiple concepts & hooks · premium motion & editing · priority production · 2 revision rounds" },
      ],
    },
  },
  es: {
    ...
    plans: {
      essential: {
        name: "Essential",
        volume: "8 videos / mes",
        description: "El punto de entrada más simple a una partnership creativa mensual.",
        price: "$460",
        cta: "Empezar Essential",
        features: ["8 videos por mes", "12 fotos de producto", "Dirección creativa", "Múltiples conceptos y hooks", "2 rondas de revisiones"],
      },
      growth: {
        name: "Growth",
        volume: "12 videos / mes",
        description: "La partnership mensual con mejor valor para marcas que testean y escalan creativos.",
        price: "$620",
        cta: "Elegir Growth",
        features: ["12 videos por mes", "20 fotos de producto", "Dirección creativa", "Múltiples conceptos y hooks", "Motion y edición premium", "2 rondas de revisiones"],
      },
      scale: {
        name: "Scale",
        volume: "16+ videos / mes",
        description: "Para marcas que necesitan alto volumen creativo constante — el precio parte de $790 y escala con la producción.",
        price: "$790+",
        cta: "Escalar con Vantads",
        features: ["16+ videos por mes", "36 fotos de producto", "Mayor volumen creativo", "Múltiples conceptos y hooks", "Motion y edición premium", "Producción prioritaria", "2 rondas de revisiones"],
      },
    },
    ...
    info: {
      ...
      priceNote: "Todos los precios en USD, cobrados mensualmente.",
      ...
      plans: [
        { name: "Essential", volume: "8 videos / mes", price: "$460 / mes", features: "8 videos · 12 fotos de producto · dirección creativa · múltiples conceptos y hooks · 2 rondas de revisiones" },
        { name: "Growth", volume: "12 videos / mes", price: "$620 / mes", features: "12 videos · 20 fotos de producto · dirección creativa · múltiples conceptos y hooks · motion y edición premium · 2 rondas de revisiones" },
        { name: "Scale", volume: "16+ videos / mes", price: "Desde $790 / mes", features: "16+ videos · 36 fotos de producto · mayor volumen creativo · múltiples conceptos y hooks · motion y edición premium · producción prioritaria · 2 rondas de revisiones" },
      ],
    },
  },
} as const;
