...
export function SiteHeader() {
  ...
  return <header className="absolute inset-x-0 top-0 z-20 px-5 py-6 sm:px-8 sm:py-7">
    <nav className="mx-auto flex max-w-[1038px] items-center justify-between" aria-label="Main navigation">
      ...
      <a href="#studio" className="flex h-7 shrink-0 items-center"><span className="hidden font-mono text-[12px] font-medium tracking-[.18em] text-white md:inline">{t("brand")}</span><img src="/vantadslogo.png" alt={t("brand")} className="h-full w-auto object-contain md:hidden" /></a>
